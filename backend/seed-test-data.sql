...
CROSS JOIN (VALUES
  ...
  ('Tom Nakamura',      'tom.n@email.com',       '29 Concord Avenue',      'Somerville', 42.3808, -71.0968, 25,  NULL, '4 steps, narrow stairway',            'approved',     'Cozy space, intimate setting'),
  ...
  ('Nina Okafor',       'nina.o@email.com',      '22 Hancock Street',      'Somerville', 42.3780, -71.0910, 30,  NULL, '3 steps',                             'pending',      NULL),
