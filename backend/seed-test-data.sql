...
CROSS JOIN (VALUES
  ...
  ('Tom Nakamura',      'tom.n@email.com',       '29 Concord Avenue',      'Somerville', 42.3808, -71.0968, 25,  NULL, NULL,                                  '4 steps, narrow stairway',            'approved',     'Cozy space, intimate setting'),
  ...
  ('Nina Okafor',       'nina.o@email.com',      '22 Hancock Street',      'Somerville', 42.3780, -71.0910, 30,  NULL, NULL,                                  '3 steps',                             'pending',      NULL),
...
CROSS JOIN (VALUES
  ...
  ('The Midnight Bicycle',  'Leo Strauss',      'leo@midnightbicycle.com',   '617-555-0220', 'Post-Punk',         '4',  'https://soundcloud.com/midnightbicycle',           'Dark, driving post-punk with jagged guitars and brooding vocals. Joy Division meets the neighborhood.',                   '45', '@midnightbicycle', '@midnight_bicycle', NULL,              'midnightbicycle', NULL,            NULL, 'https://midnightbicycle.com', 'Late slots only, 5pm+',                   'agree', 'agree', 'agree', NULL,                   NULL,                                          'pending',  NULL),
  ('Pollen',                'Dani Reeves',      'dani@pollenmusic.com',      '617-555-0221', 'Chamber Pop',       '5',  'https://bandcamp.com/pollenmusic',                 'Strings, woodwinds, and synths woven into lush pop arrangements. Like a garden in bloom.',                                '45', '@pollenmusic',     '@pollen_music',     'pollenmusic',     NULL,            NULL,              NULL, 'https://pollenmusic.com',     'Need covered space for cello',            'agree', 'agree', 'agree', NULL,           'Our cellist needs protection from weather',   'pending',  'Check weather/covered porch availability'),
  ('Neighborhood Watch',    'Tyler Brooks',     'tyler@nwatchband.com',      '617-555-0222', 'Ska/Punk',          '6',  'https://youtube.com/nwatchband',                   'Third-wave ska with punk energy. Horns, checkerboard everything, and more skanking than you can handle.',                  '30', '@nwatchband',      '@nwatch_band',      NULL,              NULL,            'nwatchband',      NULL, NULL,                          'Anytime, we bring the party',             'agree', 'agree', 'agree', NULL,       NULL,                                          'pending',  NULL),

  -- UNDER REVIEW bands (5)
  ('Rust & Rye',            'Colton Hayes',     'colton@rustandrye.com',     '617-555-0223', 'Roots Rock',        '4',  'https://soundcloud.com/rustandrye',                'Gritty roots rock with whiskey-soaked vocals. Lap steel, telecasters, and tales from the road.',                           '45', '@rustandrye',      '@rust_and_rye',     'rustandrye',      NULL,            NULL,              NULL, NULL,                          'Mid-afternoon',                           'agree', 'agree', 'agree', NULL,       NULL,                                          'under_review', 'Reviewing sample quality'),
  ('Starling',              'Wren Calloway',    'wren@starlingmusic.net',    '617-555-0224', 'Art Rock',          '3',  'https://bandcamp.com/starlingmusic',               'Experimental art rock trio. Unconventional song structures, found sounds, and visual projections.',                        '30', '@starlingmusic',   '@starling_music',   NULL,              'starlingmusic', NULL,              NULL, 'https://starlingmusic.net',   'Need power for projector as well',        'agree', 'agree', 'agree', NULL, 'We do visual projections — is that OK at a daytime fest?', 'under_review', 'Interesting concept, need to verify logistics'),
  ('The Compost Heap',      'Sage Moreno',      'sage@compostheap.band',     '617-555-0225', 'Psychedelic Rock',  '4',  'https://spotify.com/compostheap',                  'Psychedelic jams that grow organically. Long songs, weird sounds, and lots of pedals.',                                    '60', '@compostheap',     '@the_compost_heap', NULL,              'compostheap',   NULL,              NULL, NULL,                          'We need at least a 60-min slot',          'agree', 'agree', 'agree', NULL,      'Our songs average 15 minutes',                'under_review', '60-min set might be hard to schedule'),
  ('Paper Lanterns',        'Ivy Chen',         'ivy@paperlanterns.band',    '617-555-0226', 'Dream Pop',         '3',  'https://youtube.com/paperlanternsband',             'Delicate dream pop with reverb-soaked guitars and whispery vocals. Quiet beauty for a noisy world.',                      '30', '@paperlanterns',   '@paper_lanterns',   'paperlanterns',   NULL,            NULL,              NULL, 'https://paperlanterns.band',  'Quieter time slot preferred',             'agree', 'agree', 'agree', NULL,    'We are very quiet — can we be far from louder bands?',    'under_review', 'Volume scheduling consideration'),
  ('Iron Patio Furniture',  'Blake Morrison',   'blake@ironpatio.com',       '617-555-0227', 'Metal',             '5',  'https://bandcamp.com/ironpatiofurniture',          'Heavy metal that shakes the foundation. Dual guitars, blast beats, and enough bass to rattle the china.',                  '30', '@ironpatio',       '@iron_patio',       NULL,              'ironpatio',     NULL,              NULL, NULL,                          'We can play quieter if needed...',         'agree', 'agree', 'agree', NULL,        'Seriously, we can tone it down. Promise.',     'under_review', 'Need to discuss volume expectations'),

  -- REJECTED bands (3)
  ('DJ Bass Cannon',        'Kyle Pratt',       'kyle@basscannon.dj',        '617-555-0228', 'Dubstep/EDM',       '1',  'https://soundcloud.com/djbasscannon',              'BASS. DROPS. EVERY. THIRTY. SECONDS. Bring earplugs or don''t come.',                                                     '60', '@djbasscannon',    '@dj_bass_cannon',   NULL,              'djbasscannon',  NULL,              NULL, NULL,                          'Midnight slot? Just kidding. Or am I?',   'agree', 'agree', 'agree', NULL,                   NULL,                                          'rejected', 'Volume far too high for residential neighborhood'),
  ('The Algorithms',        'Chad Worthington',  'chad@thealgorithms.ai',    '617-555-0229', 'AI-Generated',      '0',  'https://suno.ai/thealgorithms',                    'Fully AI-generated music performed by laptops on stands. No humans involved. The future is now.',                          '120','@thealgorithms',   '@the_algorithms',   NULL,              NULL,            NULL,              NULL, 'https://thealgorithms.ai',    'Our laptops are always available',         'agree', 'agree', 'agree', NULL, 'Do we count as a band if no one is in the band?',        'rejected', 'Must have live human performers'),
  ('Screaming Into Void',   'Raven Blackwood',  'raven@screamvoid.com',      '617-555-0230', 'Noise',             '1',  'https://bandcamp.com/screamingintovoid',           'One person, one microphone, one long unbroken scream. Art.',                                                               '90', '@screamvoid',      '@screaming_void',   NULL,              'screamvoid',    NULL,              NULL, NULL,                          'I only perform at dawn or dusk',          'agree', 'agree', 'agree', NULL, 'This is a legitimate art form',                           'rejected', 'Not a good fit for a family-friendly neighborhood festival')
