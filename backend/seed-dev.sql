...
-- Bands
INSERT INTO bands (id, event_id, band_name, contact_name, contact_email, contact_phone, genre, member_count, music_sample_link, bio, set_length, venmo_handle, instagram, spotify, soundcloud, bandcamp, facebook, website, scheduling_notes, equipment_consent, payment_consent, timeline_consent, photo_key, questions_comments, status, admin_notes, assigned_porch_id, set_start_time, set_end_time, assigned_reviewer_id, assigned_reviewer_email, reviewer_rating, reviewer_notes, created_at) VALUES
('band-001', 'event-001', 'The Porch Rockers', 'Jake Thompson', 'jake@porchrockers.com', '555-0101', 'Rock', '4', 'https://soundcloud.com/porchrockers/demo', 'High-energy rock band from downtown. We bring the party to every porch!', '45', '@porchrockers', '@theporchrockers', NULL, 'porchrockers', NULL, NULL, 'https://porchrockers.com', 'Available all day, prefer afternoon slots', 'agree', 'agree', 'agree', NULL, NULL, 'approved', 'Great demo, confirmed for main stage porch', 'porch-003', '14:00', '14:45', NULL, NULL, NULL, NULL, '2026-01-15T10:00:00.000Z'),
('band-002', 'event-001', 'Acoustic Sunrise', 'Maria Santos', 'maria@acousticsunrise.com', '555-0102', 'Folk/Acoustic', '2', 'https://spotify.com/acousticsunrise', 'Duo playing original folk songs with guitar and violin harmonies.', '30', '@acousticsunrise', '@acoustic_sunrise', 'acousticsunrise', NULL, 'acousticsunrise', NULL, NULL, 'Morning slots preferred', 'agree', 'agree', 'agree', NULL, 'We can also do a kids set if needed!', 'approved', NULL, 'porch-001', '12:00', '12:30', NULL, NULL, NULL, NULL, '2026-01-16T14:30:00.000Z'),
('band-003', 'event-001', 'Jazz Collective', 'Marcus Williams', 'marcus@jazzcollective.net', '555-0103', 'Jazz', '5', 'https://bandcamp.com/jazzcollective', 'Five-piece jazz ensemble bringing smooth sounds to the neighborhood.', '60', NULL, '@jazzcollective', NULL, NULL, 'jazzcollective', 'jazzcollectiveband', 'https://jazzcollective.net', 'Need at least 10x10 space for setup', 'agree', 'agree', 'agree', NULL, 'Do you have any porches with shade?', 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-20T09:15:00.000Z'),
('band-004', 'event-001', 'The Garage Kids', 'Tommy Chen', 'tommy@garagekids.band', '555-0104', 'Punk', '3', 'https://soundcloud.com/garagekids', 'Loud, fast, and fun. We promise to keep it under 85db!', '30', '@garagekidsband', '@garage_kids', NULL, 'garagekids', NULL, NULL, NULL, NULL, 'agree', 'agree', 'agree', NULL, NULL, 'under_review', 'Need to confirm volume levels', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-22T16:45:00.000Z'),
('band-005', 'event-001', 'Bluegrass Battalion', 'Earl Patterson', 'earl@bluegrassbattalion.com', '555-0105', 'Bluegrass', '4', 'https://youtube.com/bluegrassbattalion', 'Traditional bluegrass with a modern twist. Banjos, fiddles, and good times.', '45', '@bluegrassbattalion', NULL, NULL, NULL, NULL, 'bluegrassbattalion', 'https://bluegrassbattalion.com', 'Any time works for us!', 'agree', 'agree', 'agree', NULL, NULL, 'rejected', 'Unfortunately fully booked this year, invited for next year', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-25T11:00:00.000Z')
ON CONFLICT DO NOTHING;
