      ...
      <div className="mb-6">
        <div className="flex flex-col lg:flex-row lg:items-center gap-3 mb-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              type="button"
              onClick={() => exportWebsiteBands(bands, approvedPorches)}
              className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium rounded-full border border-porch-200 bg-porch-50 text-porch-700 hover:bg-porch-100 hover:border-porch-300 transition-all whitespace-nowrap"
              title="Export approved bands as bands.json for the porchfest website"
            >
              <svg
                className="w-4 h-4"
                fill="none"
